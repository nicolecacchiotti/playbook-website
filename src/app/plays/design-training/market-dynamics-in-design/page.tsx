...
export default function MarketDynamicsInDesignPage() {
  const title = "Market Dynamics in Design";
  const section = "Design Training";
  const audioUrl = "/audio/Market Dynamics in Design.m4a";
      ...
      <div className="max-w-4xl mx-auto bg-card p-8 rounded-lg shadow-md">
        ...
        <div className="mt-6 space-y-6">
          ...
          <p className="text-foreground" style={{ fontSize: '14px' }}>
            Understanding market dynamics helps designers create solutions that are competitive, relevant, and positioned for success in the current market landscape.
          </p>
          <AudioPlayerWrapper 
            audioUrl={audioUrl} 
            imageSrc={designPlanArt}
            title="Market Dynamics in Design"
