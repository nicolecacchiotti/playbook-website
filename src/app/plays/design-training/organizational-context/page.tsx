...
export default function OrganizationalContextPage() {
  const title = "Organizational Context";
  const section = "Design Training";
  const audioUrl = "/audio/Organizational Context.m4a";
      ...
      <div className="max-w-4xl mx-auto bg-card p-8 rounded-lg shadow-md">
        ...
        <div className="mt-6 space-y-6">
          ...
          <p className="text-foreground" style={{ fontSize: '14px' }}>
            Understanding organizational context helps designers navigate complex stakeholder relationships and create solutions that work within the client's organizational structure and culture.
          </p>
          <AudioPlayerWrapper 
            audioUrl={audioUrl} 
