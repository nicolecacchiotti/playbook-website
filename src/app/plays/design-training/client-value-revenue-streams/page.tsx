...
export default function ClientValueRevenueStreamsPage() {
  const title = "Client Value & Revenue Streams";
  const section = "Design Training";
  const audioUrl = "/audio/Client Value & Revenue Streams.m4a";
      ...
      <div className="max-w-4xl mx-auto bg-card p-8 rounded-lg shadow-md">
        ...
        <div className="mt-6 space-y-6">
          ...
          <p className="text-foreground" style={{ fontSize: '14px' }}>
            Understanding client value propositions and revenue streams is essential for designers to create solutions that align with business objectives and drive measurable outcomes.
          </p>
          <AudioPlayerWrapper 
            audioUrl={audioUrl} 
            imageSrc={designPlanArt}
            title="Client Value & Revenue Streams"
