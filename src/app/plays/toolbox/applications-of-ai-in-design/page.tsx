      ...
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        <div className="mt-6 space-y-6">
          ...
          <p className="text-gray-700 leading-relaxed">
            Placeholder description for Applications of AI in Design.
          </p>
          <AudioPlayerWrapper 
            audioUrl={audioUrl} 
          ...
          {selectedTab === 0 && (
            <div className="mt-8" id="overview-content">
              ...
              <p className="text-gray-700 mb-6 leading-relaxed">
                Placeholder content for why to use Applications of AI in Design.
              </p>
              
              <h2 className="text-xl font-semibold mb-4 text-gray-800">When to use this play</h2>
              <p className="text-gray-700 mb-4 leading-relaxed">
                Placeholder content for when to use Applications of AI in Design.
              </p>
            </div>
          )}
          {selectedTab === 1 && (
            <div className="mt-8" id="planning-content">
              ...
              <p className="text-gray-700 mb-6 leading-relaxed">
                Placeholder content for planning and preparation of Applications of AI in Design.
              </p>
            </div>
          )}
          {selectedTab === 2 && (
            <div className="mt-8" id="how-to-run-content">
              ...
              <p className="text-gray-700 mb-6 leading-relaxed">
                Placeholder content for how to apply AI in Design.
              </p>
            </div>
          )}
          {selectedTab === 3 && (
            <div className="mt-8" id="support-content">
              ...
              <p className="text-gray-700 mb-6 leading-relaxed">
                Placeholder content for support and troubleshooting AI applications in Design.
              </p>
            </div>
          )}
        </div>
